<?php
	...
	*/
	...
	class token {
		...
		function _($file, $methods, $env = 0) {
			$this->exceptions[$env][$file] = explode(',', str_replace(' ', '', $methods));
		}
		
		function check_exception($file, $method, $env = 0) {
