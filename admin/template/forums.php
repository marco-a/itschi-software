...
<div class="h2box">
	...
	<div class="fRight" style="padding-top: 30px; width: 40%; text-align: right;">
		<a href="forum-new.php" class="button">Neues Forum erstellen</a>
	</div>
				...
				<?php if ($forums['IS_CATEGORY']): ?>
					<table cellspacing="0" cellpadding="5" width="100%">
						<tr>
							...
							<th width="40px">
								<a href="forums.php?down=<?=$forums['ID']; ?>"><img src="../images/icons/down.png" height="14px" alt="runter" /></a> &nbsp;
								<a href="forums.php?up=<?=$forums['ID']; ?>"><img src="../images/icons/up.png" alt="hoch" height="14px" /></a>
							</td>
								...
								<?php
									if (count($forums['SUBFORUMS']) > 0) {
										...
										foreach ($forums['SUBFORUMS'] as $s) {
											$subforums .= '<a href="./forum-new.php?id='.$s['forum_id'].'">'.$s['forum_name'].'</a>, ';
										}
