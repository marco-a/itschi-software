				...
				<div class="item">
					...
					<div class="fRight" style="width: 29%; text-align: right;">
						<?php if (!$style['ACTIVATED']): ?>
							...
							<?php else: ?>
								<a href="./styles.php?removeStyle=<?=$style['DIRNAME']; ?>" class="button redB" onclick="return confirm('Willst du diesen Style (<?=$style['TITLE']; ?>) wirklich löschen?');">löschen</a>
							<?php endif; ?>

							<?php if ($style['COMPATIBLE']): ?>
								<a href="./styles.php?activateStyle=<?=$style['DIRNAME']; ?>" class="button greenB">Aktivieren</a>
							<?php else: ?>
								<br /><br />
				...
				<div class="item">
					...
					<div class="fRight" style="width: 29%; text-align: right;">
						<?php if (!$badStyle['NONREMOVABLE']): ?>
							<a href="./styles.php?removeStyle=<?=$badStyle['DIRNAME']; ?>" class="button redB" onclick="return confirm('Willst du diesen fehlerhaften Style wirklich löschen?');">löschen</a>
						<?php else: ?>
