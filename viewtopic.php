<?php
	...
	*/
	...
	if (!$row) {
		...
		message_box('Du bist nicht berechtigt das Thema zu sehen', 'forum.php', 'zur&uuml;ck zum Forum');
	}
	...
	$res2 = $db->query('
		SELECT p.*, u.user_id, u.username, u.user_rank, u.user_level, u.user_posts, u.user_avatar, u.user_signatur, u.user_signatur_bbcodes, u.user_signatur_smilies, u.user_signatur_urls
		FROM ' . POSTS_TABLE . ' p
